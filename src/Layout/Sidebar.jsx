  ...
  const getMenuItems = () => {
    const menuItems = {
      ...
      COMPANY: [
        ...
        renderExpandableSection("Inventory", [
          ...
          { to: "/company/inventory-adjustment", label: "Inventory Adjustment" },
        ], "fas fa-warehouse"),

        renderExpandableSection("HR & Payroll", [
          { to: "/company/department-analytics-dashboard", label: "Dashboard" },
        ...
        renderExpandableSection("Task Management", [
        ...
        renderExpandableSection("Compliance & Integration", [
          { to: "/company/zatca-e-invoicing", label: "ZATCA e-Invoicing" },
          { to: "/company/saudicomplianceintegration", label: "Compliance Integration" },
        ], "fas fa-certificate"),

        navItem("/company/audit-logs", "fas fa-list-alt", "Audit Logs"),
        navItem("/company/support-tickets", "fas fa-life-ring", "Support Tickets"),
        
        renderExpandableSection("Settings", [
        ...
        renderExpandableSection("Voucher", [
        ...
        renderExpandableSection("Reports", [
          ...
          { to: "/company/income-statement-report", label: "Income Statement Report" },
          { to: "/company/account-statement-report", label: "Account Statement Report" },
        ], "fas fa-chart-bar"),
      ],
    };
