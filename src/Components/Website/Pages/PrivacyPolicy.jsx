...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="privacy-policy-page" style={{ backgroundColor: '#f0f7f8', fontFamily: 'Segoe UI, sans-serif', color: '#333' }}>
      {/* Hero Section */}
      <section className="text-white py-5" style={{ backgroundColor: "#023347" }}>
        <Container fluid className="text-center px-4 px-md-5">
          <div className="mb-4 d-inline-block p-3 rounded-circle bg-white bg-opacity-20" data-aos="zoom-in">
            <FaShieldAlt size={70} style={{ color: '#e6f3f5' }} />
          </div>
          <h1 className="display-4 fw-bold mb-4" data-aos="fade-down">Privacy Policy</h1>
          <p className="lead opacity-75 px-3" style={{ fontSize: '1.25rem', maxWidth: '900px', margin: '0 auto' }} data-aos="fade-up">
            ...
            <Col lg={12}>
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 10px 30px rgba(2, 51, 71, 0.08)',
                  fontSize: '1.1rem',
                  lineHeight: '1.8',
                }}
                data-aos="fade-up"
              >
                ...
                <section className="mb-5" data-aos="fade-up" data-aos-delay="100">
                  <h2 className="fw-bold d-flex align-items-center mb-4 pb-2 border-bottom" style={{ borderColor: '#023347', fontSize: '1.75rem' }}>
                    <FaUserLock className="me-3" style={{ color: '#023347', fontSize: '1.6rem' }} />
                    Introduction
                  </h2>
                  ...
                  <div className="alert alert-light border border-secondary-subtle small mt-3" role="alert" style={{ fontSize: '1.05rem', backgroundColor: '#e6f3f5' }}>
                ...
                <section className="mb-5" data-aos="fade-up" data-aos-delay="200">
                  <h2 className="fw-bold d-flex align-items-center mb-4 pb-2 border-bottom" style={{ borderColor: '#023347', fontSize: '1.75rem' }}>
                    <FaGlobe className="me-3" style={{ color: '#023347', fontSize: '1.6rem' }} />
                  ...
                  <ul className="list-group list-group-flush mb-4">
                    <li className="list-group-item border-0 ps-0 py-2" style={{ fontSize: '1.1rem' }}>
                      <i className="fas fa-check-circle" style={{ color: '#2a8e9c', marginRight: '8px' }}></i> <strong>Access & Export:</strong> Download ledgers, reports, or customer lists anytime.
                    </li>
                    <li className="list-group-item border-0 ps-0 py-2" style={{ fontSize: '1.1rem' }}>
                      <i className="fas fa-check-circle" style={{ color: '#2a8e9c', marginRight: '8px' }}></i> <strong>Update & Correct:</strong> Edit vendor details, product SKUs, or bank info directly.
                    </li>
                    <li className="list-group-item border-0 ps-0 py-2" style={{ fontSize: '1.1rem' }}>
                      <i className="fas fa-check-circle" style={{ color: '#2a8e9c', marginRight: '8px' }}></i> <strong>Delete & Anonymize:</strong> Request permanent deletion of your account + all data.
                    </li>
                    <li className="list-group-item border-0 ps-0 py-2" style={{ fontSize: '1.1rem' }}>
                      <i className="fas fa-check-circle" style={{ color: '#2a8e9c', marginRight: '8px' }}></i> <strong>Opt-Out:</strong> Withdraw consent for emails or data processing (except legal obligations).
                    </li>
                  </ul>
                  <p className="mt-3" style={{ fontSize: '1.15rem' }}>
                    ...
                    <a
                      ...
                      style={{ color: '#023347', fontSize: '1.15rem' }}
                    >
                ...
                <section className="mb-5" data-aos="fade-up" data-aos-delay="300">
                  <h2 className="fw-bold d-flex align-items-center mb-4 pb-2 border-bottom" style={{ borderColor: '#023347', fontSize: '1.75rem' }}>
                    <FaShieldAlt className="me-3" style={{ color: '#023347', fontSize: '1.6rem' }} />
                    Data Security — Fort Knox for Your Business
                  </h2>
                  <div className="bg-light p-4 rounded-3 border-start border-5" style={{ fontSize: '1.1rem', backgroundColor: '#e6f3f5', borderColor: '#023347' }}>
                ...
                {/* Section 8 */}
                <section className="mb-5" data-aos="fade-up" data-aos-delay="400">
                  <h2 className="fw-bold d-flex align-items-center mb-4 pb-2 border-bottom" style={{ borderColor: '#023347', fontSize: '1.75rem' }}>
                    <FaChild className="me-3" style={{ color: '#023347', fontSize: '1.6rem' }} />
                    Children's Privacy
                  </h2>
                ...
                <section data-aos="fade-up" data-aos-delay="500">
                  <h2 className="fw-bold d-flex align-items-center mb-4 pb-2 border-bottom" style={{ borderColor: '#023347', fontSize: '1.75rem' }}>
                    <FaEnvelope className="me-3" style={{ color: '#023347', fontSize: '1.6rem' }} />
                    Contact Us — We're Here for You
                  </h2>
                  <p style={{ fontSize: '1.15rem' }}>Questions? Concerns? Just want to say hi? Reach out via:</p>
                  <div className="bg-light bg-opacity-5 rounded-3 p-4" style={{ backgroundColor: '#e6f3f5' }}>
      ...
      >
        <FaArrowUp size={24} style={{ color: '#fff' }} />
      </Button>
    </div>
  );
};
